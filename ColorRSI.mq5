...
#property indicator_color1  clrGray,clrDeepSkyBlue,clrRed // Neutral, Up (SkyBlue), Down (Red)
...
//--- plot properties
   ...
   PlotIndexSetInteger(0, PLOT_LINE_COLOR, 0, clrGray);       // Neutral slope
   PlotIndexSetInteger(0, PLOT_LINE_COLOR, 1, clrDeepSkyBlue); // Upward slope
...
//--- Set indicator levels from #property values
   ...
   IndicatorSetInteger(INDICATOR_LEVELCOLOR, clrGray); // Corresponds to #property indicator_levelcolor
