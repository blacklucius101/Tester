...
void CreateStopLine()
  {
   ...
   ObjectSetInteger(0, HLINE_NAME, OBJPROP_STYLE, STYLE_DASHDOTDOT);
...
void CreateStatusBox()
  {
   ...
   ObjectSetInteger(0, STATUS_BOX_NAME, OBJPROP_XDISTANCE, 280, 60);
...
//--- buttons
   ...
   CreateButton("CloseAllButton", "CLOSE ALL", 280, 50, 80, 25, clrOrange, clrWhite, CORNER_LEFT_LOWER);
