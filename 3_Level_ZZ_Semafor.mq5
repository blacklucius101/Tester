...
//---- Set colors for different levels (lighter for level 1, darker for higher levels)
   PlotIndexSetInteger(0, PLOT_LINE_COLOR, clrLightBlue);      // Level 1 Bullish - Light
   PlotIndexSetInteger(1, PLOT_LINE_COLOR, clrLightPink);      // Level 1 Bearish - Light
   ...
   PlotIndexSetInteger(4, PLOT_LINE_COLOR, clrDarkBlue);       // Level 3 Bullish - Dark
   PlotIndexSetInteger(5, PLOT_LINE_COLOR, clrDarkMagenta);    // Level 3 Bearish - Dark
