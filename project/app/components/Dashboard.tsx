...
export default function Dashboard({ user, setUser, selectedProjectType }: DashboardProps) {
  ...
  const projectDescriptions: Record<string, string> = {
    'auth-app': 'Build an app with user accounts and login',
    'social-network': 'Social network for developers',
    'ecommerce': 'E-commerce marketplace like Amazon',
  ...
  useEffect(() => {
    if (selectedProjectType && projectDescriptions[selectedProjectType]) {
      setNewProject({
        title: '',
        description: projectDescriptions[selectedProjectType]
      })
        ...
        >
          ...
          {projects.length === 0 ? (
            <div className="text-center text-white py-16">
              ...
              <p className="text-white/60 text-lg mb-4">Select a project and describe what you want to build</p>
            </div>
          ) : (
