...
input bool IsShowZoneFill = true; // Show Support & Resistance Area Fill
...
int OnInit()
{
    ...
    // Toggle fill plot visibility (Resistance & Support areas)
    PlotIndexSetInteger(5, PLOT_DRAW_TYPE, IsShowZoneFill ? DRAW_FILLING : DRAW_NONE);
    PlotIndexSetInteger(7, PLOT_DRAW_TYPE, IsShowZoneFill ? DRAW_FILLING : DRAW_NONE);
